...
public class RakNetServer {
    ...
    private RakNetServer() throws IOException {
        ...
        unconnectedPingHandler = new UnconnectedPingHandler(RakNetServer.this);
        ...
        bootstrap.group(bossGroup)
                ...
                .handler(new ChannelInitializer<DatagramChannel>() {
                    protected void initChannel(DatagramChannel ch) throws Exception {
                        ...
                        pipeline.addLast(workerGroup, "UnconnectedPingHandler", unconnectedPingHandler);
    ...
    public void setName(String name) {
        this.unconnectedPingHandler.setServerName(name);
    }
