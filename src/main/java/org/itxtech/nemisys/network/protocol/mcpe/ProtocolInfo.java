...
//    int CUSTOM_PACKET = 0xe3;
    ...
    int CLIENT_CAMERA_AIM_ASSIST_PACKET = 0x141;
    ...
    int PLAYER_LOCATION_PACKET = 0x146;
    int CLIENTBOUND_CONTROL_SCHEME_SET_PACKET = 0x147;
    int PRIMITIVE_SHAPES_PACKET = 0x148;
    int SERVERBOUND_PACK_SETTING_CHANGE_PACKET = 0x149;
    int CLIENTBOUND_DATA_STORE_PACKET = 0x14a;
    int GRAPHICS_OVERRIDE_PARAMETER_PACKET = 0x14b;
    int SERVERBOUND_DATA_STORE_PACKET = 0x14c;
    int CLIENTBOUND_DATA_DRIVEN_UI_SHOW_SCREEN_PACKET = 0x14d;
    int CLIENTBOUND_DATA_DRIVEN_UI_CLOSE_SCREEN_PACKET = 0x14e;
    int CLIENTBOUND_DATA_DRIVEN_UI_RELOAD_PACKET = 0x14f;
    int CLIENTBOUND_TEXTURE_SHIFT_PACKET = 0x150;
    int VOXEL_SHAPES_PACKET = 0x151;
    int CAMERA_SPLINE_PACKET = 0x152;
    int CAMERA_AIM_ASSIST_ENTITY_PRIORITY_PACKET = 0x153;
    int RESOURCE_PACKS_READY_FOR_VALIDATION_PACKET = 0x154;
    int LOCATOR_BAR_PACKET = 0x155;
    int PARTY_CHANGED_PACKET = 0x156;
    int SERVERBOUND_DATA_DRIVEN_SCREEN_CLOSED_PACKET = 0x157;
    int SYNC_WORLD_CLOCKS_PACKET = 0x158;
    int CLIENTBOUND_ATTRIBUTE_LAYER_SYNC_PACKET = 0x159;
    int SERVER_STORE_INFO_PACKET = 0x15a;
    int SERVER_PRESENCE_INFO_PACKET = 0x15b;
    int CLIENTBOUND_UPDATE_SOUND_DATA_PACKET = 0x15c;
    int SEND_PARTY_DESTINATION_COOKIE_PACKET = 0x15d;
    int PARTY_DESTINATION_COOKIE_RESPONSE_PACKET = 0x15e;
