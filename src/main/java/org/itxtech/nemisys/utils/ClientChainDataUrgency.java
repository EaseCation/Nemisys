...
public final class ClientChainDataUrgency implements LoginChainData {
    ...
    public static ClientChainDataUrgency read(LoginPacket pk) {
        ClientChainDataUrgency data = of(pk.getBuffer());
    ...
    public boolean equals(Object obj) {
        return obj instanceof ClientChainDataUrgency && Objects.equals(bs, ((ClientChainDataUrgency) obj).bs);
    }
