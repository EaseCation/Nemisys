...
public interface Plugin extends CommandExecutor {
     ...
     * <p>
     * <p>当你需要把一个文件的所有内容读取为字符串，可以使用{@link org.itxtech.nemisys.utils.Utils#readFile(File)}函数，
     * 来从{@code InputStream}读取所有内容为字符串。例如：<br>
     * When you need to read the whole file content as a String, you can use {@link org.itxtech.nemisys.utils.Utils#readFile(File)}
