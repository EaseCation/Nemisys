...
public class SynapsePlayer extends Player {
    ...
    public SynapsePlayer(NetworkSession session, SynapseEntry synapseEntry, Long clientID, InetSocketAddress socketAddress, Compressor compressor) {
        super(session, clientID, socketAddress, compressor);
